...
public class Contrato {
	...
	public Contrato(int id, String ejecutivo, String tipo_contrato, String horario, String f_inicio, String f_final,
			int num_visitas, String ing_visita, String mantenimiento1, String mantenimiento2, String mantenimiento3,
			String mantenimiento4, int nit) {
		super();
		this.id = id;
